...
const CANONICAL_PATHS = [
  ...
  'COMPREHENSIVE_DRIFT_PREVENTION_SUMMARY.md',
  ...
  'docs/development/VERIFICATION_GUIDE.md',
...
const ARCHIVED_PATHS = [
  ...
  'docs/archive-docs/2025-12-12-drift-prevention/IMPLEMENTATION_SUMMARY.md',
